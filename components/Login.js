...
function Login({ providers }) {
    return (
        <div className='flex flex-col items-center space-y-20 pt-48'>
            <Image
                src="https://icon-library.com/images/22224-tiger-icon_5825.png"
                width={150}
                height={150}
                objectFit="contain"
            />
            <div>
                {Object.values(providers).map(provider => (
                    <div key={provider.name}>
                        {/* http://devdojo.com/tailwindcss/button */}

                        <button className="relative inline-block text-lg group items-center font-medium
