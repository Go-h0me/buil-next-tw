...
function Input() {
  ...
  return (
    <div
      className={`flex space-x-3 overflow-y-scroll border-b border-gray-700
          ...
          <div className="flex items-center justify-between pt-2.5">
            <div className="flex items-center">
              ...
              <div className="icon rotate-90">
                <ChatAltIcon className="h-[22px] text-[#1d9bf0]" />
              </div>
