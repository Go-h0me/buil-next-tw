  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 z-50 pt-8" onClose={setIsOpen}>
        <div
          className="flex min-h-[800px] items-start justify-center
    ...
    "
        >
          ...
          >
            <div
              className="inline-block transform overflow-hidden rounded-2xl
                bg-black text-left align-bottom shadow-xl transition-all
            ...
            >
              ...
              >
                <div
                  className="hoverAnimation flex h-9 w-9
              ...
              <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
                <div className="w-full">
                  <div className="relative flex gap-x-3 text-[#6e767d]">
                    <span
                      className="absolute top-11 left-5 z-[-1] h-full
                        w-0.5 bg-gray-600
                        "
                    />
                    <img
                    ...
                    <div className="mt-2 flex-grow">
                      ...
                      <div className="flex items-center justify-between pt-2.5">
                        ...
                        <button
                          ...
                          bg-[#1d9bf0] px-4 py-1.5 font-bold text-white shadow-md
